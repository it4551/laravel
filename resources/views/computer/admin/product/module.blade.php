...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">{{ trans("admin.module_ptitle") }}</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
...
<!--                     <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="modname" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.name_cate") }}:</label>
                        <div class="col-sm-9">
...
<!--                     <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="emodname" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.name_cate") }}:</label>
                        <div class="col-sm-9">
...
@endsection()
@section('script')
  <script src="{{ asset('public/js/admin/modproduct.js') }}"></script>
