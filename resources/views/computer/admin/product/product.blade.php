...
<div id="page-wrapper">
  <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">{{ trans('translate.Product_Heading')}}</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <!-- Table Sản phẩm -->
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th>{{ trans('admin.cate_p1')}}</th>
                                        <th>{{ trans('admin.image')}}</th>                   
                                        <th>{{ trans('admin.quantity')}}</th>
                                        <th>{{ trans('admin.module_p')}}</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td editid="{{ $product->id }}">@if($product->hide==NULL || $product->hide == 0)<span class="nn_change_hide btn btn-info">{{ trans('admin.show')}}</span>@else<span class="nn_change_hide btn btn-warning">{{ trans('admin.hide')}}</span>@endif</td>            
                                        <td>
    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">{{ trans('admin.product_add_title')}}</h4>
          </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        <label for="nnmodnews" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans('admin.module_ptitle')}}:</label>
                        <div class="col-sm-9">
                            <select class="form-control" name="nnmodnews" id="nn-mod-news">
                                <option value="null">--{{ trans('admin.module_ptitle')}}--</option>
                    ...
                    <div class="form-group">
                        <label for="nnlistnew" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans('admin.cate_p2')}}:</label>
                        <div class="col-sm-9">
                            <select class="form-control" name="nnlistnew" id="nn-list-new">
                                <option value="null">--{{ trans('admin.cate_p2')}}--</option>
                                @foreach($lpro as $ls)
...
<div class="modal fade nn-modal-edit-product" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="myModalLabel">{{ trans('admin.product_edit_title')}}</h4>
          </div>
          ...
          <div class="modal-body">
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        <label for="ennmodnews" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans('admin.module_ptitle')}}:</label>
                        <div class="col-sm-9">
                            <select class="form-control" name="enmodnews" id="enn-mod-news">
                                <option value="null">--{{ trans('admin.module_p1')}}--</option>
                                @foreach($modulepro as $ls)
                    ...
                    <div class="form-group">
                        <label for="ennlistnew" class="col-sm-3 control-label"> {{ trans('admin.cate_p2')}}:</label>
                        <div class="col-sm-9">
