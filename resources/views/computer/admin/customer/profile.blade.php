    ...
    <div class="row info alert-info" style="padding: 15px 0;">         
           <div class="col-xs-6">                        
              <div class="form-group">
                <label for="nn-name-cus" class="col-xs-3 control-label"><i class="fa fa-id-badge"></i> {{ trans("admin.name_custommer") }}:</label>
                <div class="col-xs-9">
           ...
           <div class="col-xs-6">
                <div class="form-group">
                    <label for="nn-phone-cus" class="col-xs-3 control-label"><i class="fa fa-clock-o"></i> {{ trans("admin.group_cus") }}:</label>
                    <div class="col-xs-9">
