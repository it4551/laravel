            ...
            <div class="panel panel-default">
                ...
                @endif
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-customer">
                        <thead>
                            <tr>
                                <th>{{ trans("admin.name_custommer") }}</th>
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        <label for="nngroupkh" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.group_cus") }}:</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label for="nnfullname" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.name_custommer") }}:</label>
                        <div class="col-sm-9">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        <label for="enngroupkh" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.group_cus") }}:</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label for="ennfullname" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.name_custommer") }}:</label>
                        <div class="col-sm-9">
