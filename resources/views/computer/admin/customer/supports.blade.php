            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    ...
                    <div class="form-group">
                        <label for="nngroupkh" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.task_cus") }}:</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label for="nnfullname" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.name1") }}:</label>
                        <div class="col-sm-9">
                ...
                <div class="col-xs-6"> 
                    ...
                    <div class="form-group">
                        <label for="nnfacebook" class="col-sm-3 control-label"><i class="fa  fa-youtube"></i> Link FB:</label>
                        <div class="col-sm-9">
          ...
          <div class="modal-body">
            <div class="row">
                ...
                <div class="col-xs-6">
                    ...
                    <div class="form-group">
                        <label for="enngroupkh" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.task_cus") }}:</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label for="ennfullname" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.name1") }}:</label>
                        <div class="col-sm-9">
