...
@section('title','Hóa đơn bán hàng - PTPMCN Shipping')
@section('content')
<div id="page-wrapper">
	<div class="row">
    ...
    <div class="row" style="padding: 15px 0;">         
           <div class="col-xs-6">                        
              ...
              <div class="form-group">
                <label for="nn-address-cus" class="col-xs-5 control-label"><i class="fa fa-map-marker"></i> Address:</label>
                <div class="col-xs-7">
                  <p>{{ $order->address }}</p>
                </div>
              </div>
              ...
              <div class="form-group">
                <label for="nn-key-cus" class="col-xs-5 control-label"><i class="fa fa-money"></i> Tổng tiền hàng:</label>
                <div class="col-xs-7" >
                    <span id="nnshowtotal">
           ...
           <div class="col-xs-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12" style="padding-left: 30px;">
                      <p>   + D/v vận chuyển:{{ $order->shipping_name }} <br>
                            ...
                            + Đ/c nhận hàng:{{ $order->address }} <br>
                ...
                <div class="form-group">
                <label for="nn-key-cus" class="col-xs-5 control-label"><i class="fa fa-money"></i> Tổng chi phí (V/c):</label>
                <div class="col-xs-7" >
                    <span id="nnshowtotal">
