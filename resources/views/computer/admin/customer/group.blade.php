...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">{{ trans('admin.group1')}} {{ trans('admin.custommer')}}</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        <label for="listname" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans('admin.type_user')}}:</label>
                        <div class="col-sm-9">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        <label for="elistname" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans('admin.type_user')}}:</label>
                        <div class="col-sm-9">
