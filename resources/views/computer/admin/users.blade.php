                ...
                @endif
                   ...
                   <div class="col-xs-6"> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" name="nnfullname" placeholder="Họ tên">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="nnaddress" class="col-sm-4 control-label"><i class="fa fa-location-arrow"></i> Địa chỉ</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" name="nnaddress" placeholder="Địa chỉ">
                        </div>
                      </div>
                      <div class="form-group">
                   ...
                   <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="nnbirthday" placeholder="dd/MM/YYYY">
                            </div>
                          </div>
