<div class="col-md-3">
            ...
            <div class="row">  
              <div class="photo col-sm-5 col-xs-5">
                  <a href="{{ url('tin-tuc/'.$item->slug) }}">
                    <img src="{{ asset('public/img/news/'.$item->newimg) }}" class="img-responsive" alt="{{ $item->newalt }}" />
                  </a>
              </div>
    ...
    <div class="nn-banner-qc-l">
      <a href="{{ $item->link }}">
        <img src="{{ asset('public/img/advert/'.$item->img) }}">
        <img src='{{url('public/img/advert/'.$row->img)}}'>
      </a>
