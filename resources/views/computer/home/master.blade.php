                    ...
                    <div class="col-md-6 col-sm-6 nt7-padding-top">
                        <form action="{{ url('/search') }}"> 
                            <div class="form-group has-deflaut has-feedback">
                              ...
                              <label class="control-label" for="inputSuccess2" style="color:#de3737;">android - iOS operation, ...</label>
                            </div>
                        </form>
                    </div>
        ...
        <div class="container">
            ...
            <div class="col-md-4">
                <aside class="widget widget_social_icons">
                    <h3 class="widget-title">FLOW US</h3>
                    <ul>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="col-md-6 col-sm-6">
                    <p>© 2018 PTPMCN All Rights Reserved. </p>
                </div>
                <div class="col-md-6 col-sm-6">
                    <nav class="navbar navbar-default">                     
                        <div class="navbar-header">
...
<div class="phonenow visible-xs">
    ...
    <img src="http://ptpmcn.com/public/img/phonenow.png"> 0123.456.789</a>
</div>
{{-- end phone --}}
...
s1.async=true;
s1.src='https://embed.tawk.to/5c06448f40105007f37adf90/default';
s1.charset='UTF-8';
