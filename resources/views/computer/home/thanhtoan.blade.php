            ...
            <div class="col-md-12 content_checkout_thanhtoan">
              ...
              <div class="col-md-3">
                ...
                <div class="block_right_cart" {{-- style="display:none" --}}>
                  ...
                  {{-- <p class="add" id="p_pay_address">{{ Session::get('pay_address') }}</p> --}}
                  <input type="text" class="form_control" value="{{ Session::get('pay_address') }}" id="p_pay_address" > 
                  <span class="error"></span>
                </div>
                @endif
                ...
                <div class="block_right_cart" {{-- style="display:none" --}}>
                 ...
                 {{--  <p class="add" id="p_shipping_address">{{ Session::get('shipping_address') }}</p> --}}
                  <input type="text" class="form_control" value="{{ Session::get('shipping_address') }}" id="p_shipping_address" > 
                  <span class="error"></span>
                </div>
                 {{-- {{ Session::get('pay_phone') }} --}}
                <div class="block_right_cart" style="display:none">
                  <h3>{{ trans('pay.comment') }}</h3>
                  <textarea id="txtComment" class="form_control"></textarea>
                  <textarea id="txtComment" class="form_control"></textarea>
                ...
                <div class="block_right_cart">
                  ...
                  <p class="item"><span class="qty">{{ $item->qty }}</span> x <a href="{{ url('san-pham/'.$item->slug) }}" >{{ $item->name }}</a><span class="sub">{{ format_curency( $item->options->price_show ) }}</span></p>
                  @endforeach
