...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">{{ trans("admin.cate_p2") }}</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">{{ trans("admin.add") }} {{ trans("admin.cate_p2") }}</h4>
          </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        <label for="nntheloai" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.theloai1") }}:</label>
                        <div class="col-sm-9">
                            <select class="form-control" name="nntheloai">
                                <option value='xxx'>--{{ trans("admin.theloai1") }}--</option>
                    ...
                    <div class="form-group">
                        <label for="listname" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.cate_p2") }}:</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label for="type" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.type1") }}:</label>
                        <div class="col-sm-9">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        <label for="enntheloai" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.module_ptitle") }}:</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label for="elistname" class="col-sm-3 control-label"><i class="fa  fa-font"></i> {{ trans("admin.cate_p2") }}:</label>
                        <div class="col-sm-9">
