$(document).ready(function(){
    ...
    $("#btn_datmua").click(function(e){
      ...
      p_shipping_address = $('#p_shipping_address').val();
      p_pay_address = $('#p_pay_address').val();
      ...
      if(p_shipping_address == ""){
        $("#p_shipping_address + span").html('Nhập ĐC giao hàng của bạn?')
        err = 1
      }
       if(p_pay_address == ""){
        $("#p_pay_address + span").html('Nhập ĐC thanh toán của bạn?')
        err = 1
      }
      // if(sltCountpeople == ""){
